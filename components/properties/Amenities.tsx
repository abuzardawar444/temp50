...
const Amenities = ({ amenities }: { amenities: string }) => {
  // string that was stored as a result of JSON.stringify() and you want to use map() on the data it represents, you first need to parse the string back into a JavaScript object or array using JSON.parse()
  const amenitiesList: Amenity[] = JSON.parse(amenities as string);

  // Check if there's amenety offered for this property
